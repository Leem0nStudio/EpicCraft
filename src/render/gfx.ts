...
export const GFX_BUDGETS: Record<GfxTier, GfxRuntimeBudget> = {
  ...
  high: {
    targetFps: 60,
    minRenderScaleDesktop: 0.8,
    minRenderScaleMobile: 0.65,
    maxRenderScale: 1,
    dropFrameMs: 22,
    urgentFrameMs: 32,
    recoverFrameMs: 15,
  ...
  ultra: {
    targetFps: 60,
    minRenderScaleDesktop: 0.85,
    minRenderScaleMobile: 0.7,
    maxRenderScale: 1,
    dropFrameMs: 24,
    urgentFrameMs: 34,
    recoverFrameMs: 15,
...
// @param intensity - rim glow strength (0 = off, 0.06 = subtle, 0.12 = default, 0.18 = strong)
