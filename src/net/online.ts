...
export class Api {
  ...
  async createCharacter(name: string, cls: PlayerClass, skin = 0, gender: Gender = 'female'): Promise<void> {
    await this.post('/api/characters', { name, class: cls, skin, gender });
  }
