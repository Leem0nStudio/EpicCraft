...
export const CLASSES: Record<PlayerClass, ClassDef> = {
  ...
  // ====================== NOVICE ======================
  // Beginner class for the job change system. Starts weak, gains access to
  // one of the 9 main classes after reaching level 5.
  novice: {
    id: 'novice',
    name: 'Novice',
    baseStats: { str: 12, agi: 10, sta: 14, int: 14, spi: 12, armor: 15 },
    statsPerLevel: { str: 1, agi: 1, sta: 2, int: 2, spi: 1, armor: 3 },
    baseHp: 45,
    hpPerLevel: 12,
    baseMana: 80,
    manaPerLevel: 14,
    ...
    startChest: 'apprentice_robe',
    startItems: START_RATIONS_MANA,
    ranged: { min: 2, max: 5, speed: 2.0, maxRange: 20, minRange: 0, wand: true, school: 'holy' },
    abilities: [
      'novice_smite',
      'novice_heal',
      'novice_blessing',
...
export const ABILITIES: Record<string, AbilityDef> = {
  ...
  novice_smite: {
    ...
    school: 'holy',
    requiresTarget: true,
    effects: [{ type: 'directDamage', min: 10, max: 14 }],
    ranks: [
      { rank: 2, level: 3, cost: 12, effects: [{ type: 'directDamage', min: 18, max: 26 }] },
      { rank: 3, level: 5, cost: 16, effects: [{ type: 'directDamage', min: 28, max: 38 }] },
    ],
    description: 'Smites an enemy for $d Holy damage.',
  },
  novice_heal: {
    id: 'novice_heal',
    name: 'Heal',
    ...
    school: 'holy',
    requiresTarget: true,
    effects: [{ type: 'heal', min: 28, max: 36 }],
    ranks: [
      { rank: 2, level: 3, cost: 18, castTime: 2.5, effects: [{ type: 'heal', min: 55, max: 70 }] },
      { rank: 3, level: 5, cost: 24, castTime: 3.0, effects: [{ type: 'heal', min: 90, max: 115 }] },
    ],
    description: 'Heals a friendly target for $d.',
  },
  novice_blessing: {
    ...
    school: 'holy',
    requiresTarget: false,
    effects: [{ type: 'buffTarget', kind: 'buff_allstats', value: 5, duration: 60 }],
    description: 'Blesses you, increasing all stats by 5 for 1 min.',
  },
