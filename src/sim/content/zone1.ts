...
export const ZONE1_NPCS: Record<string, NpcDef> = {
  ...
  // Eastbrook Guard: defends the town from mobs that chase players
  guard_eastbrook: {
    id: 'guard_eastbrook',
    name: 'Guard Aldric',
    title: 'Eastbrook Guard',
    pos: { x: -6, z: 8 },
    facing: Math.PI / 2,
    color: 0x8e6e53,
    questIds: [],
    greeting: 'Halt, traveler. The Vale is not safe for the unprepared.',
    // Combat stats: strong enough to handle zone 1 mobs
    hpBase: 150,
    hpPerLevel: 18,
    dmgBase: 8,
    dmgPerLevel: 2.5,
    attackSpeed: 1.8,
    armorPerLevel: 14,
    combatProfile: 'defensive',
  },
  guard_eastbrook_2: {
    id: 'guard_eastbrook_2',
    name: 'Guard Beatrice',
    title: 'Eastbrook Guard',
    pos: { x: 7, z: -4 },
    facing: -Math.PI / 2,
    color: 0x8e6e53,
    questIds: [],
    greeting: 'Stay within the walls, $C. The wilds are no place for the faint-hearted.',
    // Combat stats: same as partner
    hpBase: 150,
    hpPerLevel: 18,
    dmgBase: 8,
    dmgPerLevel: 2.5,
