  ...
  handleEvents(events: SimEvent[]): void {
    ...
    for (const ev of events) {
      ...
      switch (ev.type) {
        ...
        case 'jobChangeReady': {
          // Novice reached level 5 — show job change prompt
          this.showBanner('You are ready to change class! Use /jobchange to choose your new class.');
          this.log('You are ready to change class! Use /jobchange to choose your new class.', '#ffd100');
          audio.levelUp();
          break;
        }
        case 'deedUnlocked': {
