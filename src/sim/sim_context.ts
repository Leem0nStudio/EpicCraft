...
export interface SimContextCallbacks {
  ...
  // Job change system: change a novice player's class. Resets talents and
  // refreshes abilities. Only works for novice characters at level 5+.
...
export function createSimContext(host: SimContextHost): SimContext {
  return {
    ...
    // Job change system: changePlayerClass backs the /jobchange command.
    changePlayerClass: host.changePlayerClass,
  };
}
