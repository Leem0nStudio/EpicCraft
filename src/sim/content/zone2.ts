...
export const ZONE2_NPCS: Record<string, NpcDef> = {
  ...
  // Fenbridge Guards: defend the town from zone 2 mobs
  guard_fenbridge: {
    id: 'guard_fenbridge',
    name: 'Guard Theron',
    title: 'Fenbridge Guard',
    pos: { x: -5, z: 298 },
    facing: Math.PI / 2,
    color: 0x5d6d7e,
    questIds: [],
    greeting: 'Keep your distance from the marsh, $C. The trolls lurk in the reeds.',
    // Combat stats: stronger than zone 1 guards
    hpBase: 220,
    hpPerLevel: 22,
    dmgBase: 12,
    dmgPerLevel: 3.0,
  ...
  guard_fenbridge_2: {
    ...
    color: 0x5d6d7e,
    questIds: [],
    greeting: 'The fen is restless today, $C. Stay sharp.',
