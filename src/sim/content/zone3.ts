...
export const ZONE3_NPCS: Record<string, NpcDef> = {
  ...
  // Highwatch Guards: elite defenders for the highest-level zone
  guard_highwatch: {
    id: 'guard_highwatch',
    name: 'Guard Captain',
    title: 'Highwatch Elite Guard',
    pos: { x: -7, z: 662 },
    facing: Math.PI / 2,
    color: 0x34495e,
    questIds: [],
    greeting: 'Stand tall, $C. The wall holds because we hold.',
    // Combat stats: strongest guards in the game
    hpBase: 350,
    hpPerLevel: 28,
    dmgBase: 18,
    dmgPerLevel: 4.0,
  ...
  guard_highwatch_2: {
    ...
    color: 0x34495e,
    questIds: [],
    greeting: 'The shadows grow long, $C. Watch the walls.',
  ...
  guard_highwatch_3: {
    ...
    color: 0x34495e,
    questIds: [],
    greeting: 'The north gate is watchful, $C. Rest easy.',
    // Combat stats: same as partners
    hpBase: 350,
    hpPerLevel: 28,
    dmgBase: 18,
    dmgPerLevel: 4.0,
