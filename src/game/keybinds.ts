...
export const BIND_ACTIONS: BindAction[] = [
  ...
  // Camera recenter: snaps the camera behind the player. Mobile has a two-finger
  // double-tap gesture; desktop needs a keybind. Home is natural (scroll-to-top
  // idiom) and unlikely to collide with existing bindings.
  {
    id: 'cameraRecenter',
